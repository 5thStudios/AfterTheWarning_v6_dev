...
namespace Umbraco.Web.PublishedContentModels
{
	...
	[PublishedContentModel("donations")]
	public partial class Donations : PublishedContentModel, INavigation, ISEO
	{
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Donations, TValue>> selector)
		{
		...
		/// Facebook
		///</summary>
		[ImplementPropertyType("facebookLbl")]
		public object FacebookLbl
		{
			get { return this.GetPropertyValue("facebookLbl"); }
		}

		///<summary>
		/// Facebook Url: Url to our Facebook page
		///</summary>
		...
		/// Google Wallet
		///</summary>
		[ImplementPropertyType("googleWalletLbl")]
		public object GoogleWalletLbl
		{
			get { return this.GetPropertyValue("googleWalletLbl"); }
		}

		///<summary>
		/// Google Wallet Url: Email Address: jfifth1976@gmail.com
		///</summary>
		[ImplementPropertyType("googleWalletUrl")]
		public string GoogleWalletUrl
		{
			get { return this.GetPropertyValue<string>("googleWalletUrl"); }
		}

		///<summary>
		/// Mailing Address: Mailing address for donations.
		///</summary>
		...
		/// Paypal
		///</summary>
		[ImplementPropertyType("paypalLbl")]
		public object PaypalLbl
		{
			get { return this.GetPropertyValue("paypalLbl"); }
		}

		///<summary>
		/// Paypal Url: Url to our paypal donation page.
		///</summary>
		[ImplementPropertyType("paypalUrl")]
		public string PaypalUrl
		{
			get { return this.GetPropertyValue<string>("paypalUrl"); }
		}

		///<summary>
		/// Snail Mail
		///</summary>
		[ImplementPropertyType("snailMailLbl")]
		public object SnailMailLbl
		{
			get { return this.GetPropertyValue("snailMailLbl"); }
		}
