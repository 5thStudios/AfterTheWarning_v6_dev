...
{
	/// <summary>Illumination Story List</summary>
	[PublishedContentModel("illuminationStoryList")]
	public partial class IlluminationStoryList : PublishedContentModel, INavigation, ISEO
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "illuminationStoryList";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public IlluminationStoryList(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<IlluminationStoryList, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Compiled Stories: This is the PDF version of all the submitted Illumination stories.
		///</summary>
		[ImplementPropertyType("compiledStories")]
		public IPublishedContent CompiledStories
		{
			get { return this.GetPropertyValue<IPublishedContent>("compiledStories"); }
		}

		///<summary>
		/// Form Picker: Used to report Illumination story for review.
		///</summary>
